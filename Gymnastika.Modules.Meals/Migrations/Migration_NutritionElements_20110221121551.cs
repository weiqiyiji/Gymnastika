...
{
    public class Migration_NutritionElements_20110221121551 : IDataMigration
    {
        private const string ForeignKeyName = "FK_Foods_NutritionElements";

        public string TableName 
        { 
            get { return "NutritionElements"; }
        }
